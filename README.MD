...
Since git-lfs is not free, we decided to host the `chroma.sqlite3` instance of our experiments [here](https://we.tl/t-iwYuvSbgcZ). Move it into `chroma_db`, the other required files are prepopulated.
